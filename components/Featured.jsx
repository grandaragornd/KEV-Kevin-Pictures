...
function Featured() {
  return (
    <div className='w-full p-10 custom-img bg-cover bg-fixed'>
     <div className='grid sm:grid-cols-2 text-center text-white w-full items-center justify-center gap-10'>
        ...
        <div className='shadow-2xl rounded-2xl shadow-black p-5 w-full bg-stone-900/50'>
          ...
          <Link href='https://unsplash.com/@grandaragornd' target='_blank' rel="noreferrer"><button className='p-2 m-4 border-solid border-2 border-white rounded-xl shadow-xl shadow-black'>Check it out!</button></Link>
        </div>
     </div>
    </div>
  )
